...
def speech_to_text():
    ...
    recommended_diet = capture_speech("plese state if there is any change in diet")
    if recommended_diet is None:
        return None

    return patient_name, syndrome, medication,curr_date

def save_prescription(curr_date,patient_name, syndrome, medication,recommended_diet):
...
if __name__ == "__main__":
    ...
    if prescription_info:
        curr_date,patient_name, syndrome, medication = prescription_info
        save_prescription(curr_date,patient_name, syndrome, medication)
